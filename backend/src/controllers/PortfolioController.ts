...
class PortfolioController {
  ...
  addCoins(req: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    ...
    return UserService.update(req.auth.credentials).then(user => reply(user.portfolio));
  }
  ...
  updateCoin(req: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    ...
    UserService.update(user).then(user => reply(user.portfolio));
  }
 ...
 */
  ...
  index(req: Hapi.Request, reply: Hapi.ReplyNoContinue) {
    return reply(req.auth.credentials.portfolio);
  }
}
