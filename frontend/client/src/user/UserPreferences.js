...
class UserPreferences extends Component {
  ...
  changeBittrexApiKey = e => {
    ...
    exchanges.bittrex.apiKey = e.target.value;
  ...
  changeBittrexApiSecret = e => {
    const exchanges = this.state.exchanges;
    exchanges.bittrex.apiSecret = e.target.value;
    this.setState({ exchanges });
    this.delayedCallback(e);
  }
    ...
    return (
      <form className={formStyles.form}>
        ...
        <div className={formStyles.group}>
            ...
            />
            <span className={formStyles.descriptor}>
                Here you can enter a total initial investment if you don't remember the amount spend per coin
                (if this is > 0, then the price per coin will be ignored)
            </span>
        </div>
