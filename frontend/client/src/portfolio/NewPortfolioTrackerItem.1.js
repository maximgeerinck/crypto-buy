        ...
        return (
            <ul className={styles.change}>
                <li>
                    ...
                    <span className={classChangeHour}>{round(changeHour, 2)}%</span>
                </li>
                <li>
                    <span className={styles.changeType}>D</span>
                    <span className={classChangeDay}>{round(changeDay, 2)}%</span>
                </li>
                <li>
                    <span className={styles.changeType}>W</span>
                    <span className={classChangeWeek}>{round(changeWeek, 2)}%</span>
                </li>
            </ul>
        );
    }
        ...
        return (
            <div className={classChangeTotal}>
                <div className={styles.percentage}>
                    {changeTotal}%{priceChangeIndicator}
                </div>
                {coinProfitDisplay}
            </div>
        );
